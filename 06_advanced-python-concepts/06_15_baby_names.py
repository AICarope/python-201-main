...
#The filter() function will apply the lambda to each item in the names list, and the list() constructor will then convert the result back into a list.
...
baby_names_with_M = list(filter(lambda names: names.startswith('M'), names))
print(baby_names_with_M)                                                            
